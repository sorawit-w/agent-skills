...
- [`pitch-deck`](#pitch-deck) — reads the brand design system (`docs/brand/design-system.md` or v1 `brand-kit/design-system.md`) for consistent branding and owns the deck construction itself.
...
- [`brand-workshop`](#brand-workshop) — reads the brand design system (`docs/brand/design-system.md` or v1 `brand-kit/design-system.md`) for visuals.
